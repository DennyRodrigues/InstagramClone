...
public class StudentService {
    ...
    public Student updateStudent(Long id, Map<String, Object> student) {
        ...
        if (student.containsKey("name") && student.get("name") != null && !student.get("name").toString().isEmpty()) {
            existingStudent.setName(student.get("name").toString());
        }
        ...
        if (student.containsKey("email") && student.get("email") != null && !student.get("email").toString().isEmpty()) {
            existingStudent.setEmail(student.get("email").toString());
        }
